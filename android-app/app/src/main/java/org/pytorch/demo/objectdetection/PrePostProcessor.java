...
public class PrePostProcessor {
    ...
    private static int mOutputRow = 8400; // as decided by the YOLOv8 model for input image of size 640*640
    ...
    private static float mIOUThreshold = 0.5f; // Intersection over Union threshold
